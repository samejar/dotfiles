...
##############################
# Terminal, Shell & Core CLI #
##############################
# Prefer GNU userland tools but keep macOS defaults intact.
brew 'coreutils'
brew 'moreutils'
brew 'findutils'
brew 'gnu-sed'
...
#############################################
# Source Control, IDEs & Documentation      #
#############################################
brew 'git'
brew 'git-crypt'
brew 'git-lfs'
...
# Install Serverless via npm because the Homebrew formula is deprecated upstream.
# npm install -g serverless


#################################################
# Containers, Kubernetes & Supply Chain Security #
#################################################
cask 'podman-desktop'
cask 'parallels'
brew 'colima'
...
############################################
# Downloaders, File Transfer & Filesystems #
############################################
brew 'curl'
brew 'httpie'
brew 'httrack'
...
###########################################
# Media, Graphics & Audio/Video Tools     #
###########################################
brew 'exiftool'
brew 'imagemagick'
